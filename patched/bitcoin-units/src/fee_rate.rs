...
impl FeeRate {
    ...
    /// Constructs `FeeRate` from a `u32` sat/vB value.
    ///
    /// This restores the constructor that older Bark code still calls.
    pub const fn from_sat_per_vb_u32(sat_vb: u32) -> Self { FeeRate::from_sat_per_vb_unchecked(sat_vb as u64) }
